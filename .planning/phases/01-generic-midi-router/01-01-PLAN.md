...
must_haves:
  truths:
    ...
    - "Cross-core shared variables (midi_host_mounted, midi_dev_addr) are marked volatile"
    - "Cross-core access to multi-byte shared state uses RP2040 mutex synchronization"
  artifacts:
